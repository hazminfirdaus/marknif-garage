            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlpt2="";
                        if(!empty($_POST["mecid"])){
                            $mecid=$_POST["mecid"];
                            $sqlpt2=" mechanic.mecid=$mecid ";
                        }
                        //echo $sqlpt2;
                        //echo $sqlpt1;
                        $sqlmain= "select schedule.scheduleid,schedule.title,mechanic.mecname,schedule.scheduledate,schedule.scheduletime,schedule.noc from schedule inner join mechanic on schedule.mecid=mechanic.mecid ";
                        ...
                        $sqlmain= "select schedule.scheduleid,schedule.title,mechanic.mecname,schedule.scheduledate,schedule.scheduletime,schedule.noc from schedule inner join mechanic on schedule.mecid=mechanic.mecid  order by schedule.scheduledate desc";
    ...
    if($_GET){
        ...
        if($action=='add-session'){
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="mecid" class="form-label">Select Mechanic: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="mecid" id="" class="box" >
                                    <option value="" disabled selected hidden>Choose Mechanic Name From the List</option><br/>';
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                    <br><br>
                        <h2>Session is Added.</h2>
                        <a class="close" href="schedule.php">&times;</a>
                        <div class="content">
                        '.substr($titleget,0,40).' is scheduled.<br><br>
            ...
            $sqlmain= "select schedule.scheduleid,schedule.title,mechanic.mecname,schedule.scheduledate,schedule.scheduletime,schedule.noc from schedule inner join mechanic on schedule.mecid=mechanic.mecid  where  schedule.scheduleid=$id";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $mecname=$row["mecname"];
            $scheduleid=$row["scheduleid"];
            ...
            $sqlmain12= "select * from appointment inner join customer on customer.cid=appointment.cid inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.scheduleid=$id;";
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-mec-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label"><b>Customers that already registered for this session:</b> ('.$result12->num_rows."/".$noc.')</label>
                                    <br><br>
                                </td>
                            </tr>
