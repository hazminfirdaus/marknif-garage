...
<?php 
                        ...
                        $list110 = $database->query("select * from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join customer on customer.cid=appointment.cid inner join mechanic on schedule.mecid=mechanic.mecid  where  mechanic.mecid=$userid ");
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    <option value="" disabled selected hidden>Choose Mechanic Name from the list</option><br/>';
                                        ...
                                        $list11 = $database->query("select  * from  mechanic;");
