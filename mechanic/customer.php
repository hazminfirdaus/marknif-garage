                    ...
                    if($_POST){
                        ...
                        if(isset($_POST["filter"])){
                            if($_POST["showonly"]=='all'){
                                ...
                                $sqlmain= "select * from appointment inner join customer on customer.cid=appointment.cid inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.mecid=$userid;";
                                $selecttype="My";
                                $current="My Customers Only";
                            }
                        }
...
<?php
                               ...
                               //$list12= $database->query("select * from appointment inner join customer on customer.cid=appointment.cid inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.mecid=1;");
