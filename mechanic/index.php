...
<head>
    ...
    <title>Mechanic's Dashboard</title>
    <style>
        .dashboard-tables,.mechanic-header{
...
<?php 
                ...
                <tr>
                    ...
                    <center>
                    <table class="filter-container mechanic-header" style="border: none;width:95%" border="0" >
                    <tr>
                        <td >
                            <h3>Welcome!</h3>
                            <h1><?php echo $username ?></h1>
                            <p>Thanks for joining us. We are always trying to get you a complete service.<br>
                            You can view and manage your daily schedule.<br><br>
                            </p>
