<?php
    ...
    $userrow = $database->query("select * from mechanic where mecemail='$useremail'");
     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                 <td class="menu-btn menu-icon-customer">
                     <a href="customer.php" class="non-style-link-menu"><div><p class="menu-text">My Customers
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("select  * from  schedule where mecid=$userid;");
                ...
                $sqlmain= "select schedule.scheduleid,schedule.title,mechanic.mecname,schedule.scheduledate,schedule.scheduletime,schedule.noc from schedule inner join mechanic on schedule.mecid=mechanic.mecid where mechanic.mecid=$userid ";
                    if($_POST){
                        //print_r($_POST);
                        $sqlpt1="";
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-mec-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label"><b>Customers that are already registered for this session:</b> ('.$result12->num_rows."/".$noc.')</label>
                                    <br><br>
                                </td>
                            </tr>
